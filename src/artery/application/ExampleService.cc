...
void ExampleService::initialize()
{
    ...
    EV_INFO << "Ddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd" << endl;
...
void ExampleService::handleMessage(cMessage* msg)
{
	...
	EV_INFO << "cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc" << endl;
	if (msg == m_self_msg) {
...
{
    EV_INFO << "bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb" << endl;
