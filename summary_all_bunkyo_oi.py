...
ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[0]], len(all_pdrs[0]), marker='o', edgecolors="indigo", label='Original PCAM (PPS: 50)')
ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[1]], len(all_pdrs[1]), marker='x', edgecolors="hotpink", label='Original PCAM (PPS: 100)')
ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[2]], len(all_pdrs[2]), marker='^', edgecolors="red", label='Original PCAM (PPS: 150)')
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[3]], len(all_pdrs[3]), marker='o', edgecolors="darkorange" , label='Non priority Grid PCAM (PPS: 50)')
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[4]], len(all_pdrs[4]), marker='o', edgecolors="purple",  label='Non priority Grid PCAM (PPS: 100)')
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[5]], len(all_pdrs[5]), marker='o', edgecolors="teal" , label='Non priority Grid PCAM (PPS: 150)')
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[6]], len(all_pdrs[6]), marker='o', edgecolors="limegreen",  label='Distance priority Grid PCAM (PPS: 50)')
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[7]], len(all_pdrs[7]), marker='o', edgecolors="darkgreen" , label='Distance priority Grid PCAM (PPS: 100)')
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[8]], len(all_pdrs[8]), marker='o', edgecolors="navy", label='Distance priority Grid PCAM (PPS: 150)')
...
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[0]], len(all_pdrs[0]), marker='o', edgecolors="indigo", label='Original PCAM (PPS: 50)')
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[1]], len(all_pdrs[1]), marker='o', edgecolors="hotpink", label='Original PCAM (PPS: 100)')
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[2]], len(all_pdrs[2]), marker='o', edgecolors="red", label='Original PCAM (PPS: 150)')
ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[3]], len(all_pdrs[3]), marker='o', edgecolors="darkorange" , label='Non priority Grid PCAM (PPS: 50)')
ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[4]], len(all_pdrs[4]), marker='o', edgecolors="purple",  label='Non priority Grid PCAM (PPS: 100)')
ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[5]], len(all_pdrs[5]), marker='o', edgecolors="teal" , label='Non priority Grid PCAM (PPS: 150)')
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[6]], len(all_pdrs[6]), marker='o', edgecolors="limegreen",  label='Distance priority Grid PCAM (PPS: 50)')
...
ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_delays[0]], len(all_pdrs[0]), marker='o', edgecolors="indigo", label='Original PCAM (PPS: 50)')
ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_delays[1]], len(all_pdrs[1]), marker='o', edgecolors="hotpink", label='Original PCAM (PPS: 100)')
ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_delays[2]], len(all_pdrs[2]), marker='o', edgecolors="red", label='Original PCAM (PPS: 150)')
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[3]], len(all_pdrs[3]), marker='o', edgecolors="darkorange" , label='Non priority Grid PCAM (PPS: 50)')
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[4]], len(all_pdrs[4]), marker='o', edgecolors="purple",  label='Non priority Grid PCAM (PPS: 100)')
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[5]], len(all_pdrs[5]), marker='o', edgecolors="teal" , label='Non priority Grid PCAM (PPS: 150)')
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[6]], len(all_pdrs[6]), marker='o', edgecolors="limegreen",  label='Distance priority Grid PCAM (PPS: 50)')
...
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[1]], len(all_pdrs[1]), marker='o', edgecolors="hotpink", label='Original PCAM (PPS: 100)')
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[2]], len(all_pdrs[2]), marker='o', edgecolors="red", label='Original PCAM (PPS: 150)')
ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_delays[3]], len(all_pdrs[3]), marker='o', edgecolors="darkorange" , label='Non priority Grid PCAM (PPS: 50)')
ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_delays[4]], len(all_pdrs[4]), marker='o', edgecolors="purple",  label='Non priority Grid PCAM (PPS: 100)')
ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_delays[5]], len(all_pdrs[5]), marker='o', edgecolors="teal" , label='Non priority Grid PCAM (PPS: 150)')
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[6]], len(all_pdrs[6]), marker='o', edgecolors="limegreen",  label='Distance priority Grid PCAM (PPS: 50)')
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[7]], len(all_pdrs[7]), marker='o', edgecolors="darkgreen" , label='Distance priority Grid PCAM (PPS: 100)')
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[8]], len(all_pdrs[8]), marker='o', edgecolors="navy", label='Distance priority Grid PCAM (PPS: 150)')
...
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[4]], len(all_pdrs[4]), marker='o', edgecolors="purple",  label='Non priority Grid PCAM (PPS: 100)')
# ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_pdrs[5]], len(all_pdrs[5]), marker='o', edgecolors="teal" , label='Non priority Grid PCAM (PPS: 150)')
ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_delays[6]], len(all_pdrs[6]), marker='o', edgecolors="limegreen",  label='Distance priority Grid PCAM (PPS: 50)')
ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_delays[7]], len(all_pdrs[7]), marker='o', edgecolors="darkgreen" , label='Distance priority Grid PCAM (PPS: 100)')
ax.scatter(x, [mean(pdrs) if len(pdrs) >= 2 else 0 for pdrs in all_delays[8]], len(all_pdrs[8]), marker='o', edgecolors="navy", label='Distance priority Grid PCAM (PPS: 150)')
